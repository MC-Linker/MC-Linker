 ...
 * @param {Object<string, AdvancementData[]>} [advancementData] - The advancements to search, defaulting to the committed baseline. Pass a server version's own set (see {@link import('../structures/render/MinecraftAssetsManager.js').default.getGameData}) so that advancements added or moved between versions still resolve.
 * @returns {AdvancementData[]} - An array of matching advancements.
 */
export function searchAdvancements(searchString, category, shouldSearchNames = true, shouldSearchValues = true, maxLength = 25, advancementData = baselineAdvancements) {
